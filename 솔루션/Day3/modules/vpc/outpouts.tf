...
output "private_protect_subnet_a_id" {
  value = aws_subnet.private_protect_1.id
}

output "private_protect_subnet_c_id" {
  value = aws_subnet.private_protect_2.id
}
...
output "private_protect_table_id" {
  value = aws_route_table.private_protect.id
}