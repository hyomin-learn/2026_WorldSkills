...
PUBLIC_A_SN_NAME="apdev-public-subnet-a"
PUBLIC_C_SN_NAME="apdev-public-subnet-c"
PRIVATE_A_SN_NAME="apdev-private-subnet-a"
PRIVATE_C_SN_NAME="apdev-private-subnet-c"
